...
namespace WhereYouAtCoreApi.Models {
    ...
    public class LocUpdate {
        ...
        public int IsBg { get; set; } = 0;
        public string? Misc1 {get; set; }

		public LocUpdate() { }

        public LocUpdate(string tripcode, long memberid, decimal lat, decimal lon, decimal? speed = 0, string? displayname = null, string? token = null, string? googleid = null, string? avatarurl = null, string? email = null, int isBg = 0, string? misc = null) {
